...
public class ChatActivityStudent extends AppCompatActivity implements OnResponseListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivity = ChatActivityStudent.this;
        utils = new Utils();
    ...
    private void clickProfile(View view) {
        ...
        Intent intent = new Intent(ChatActivityStudent.this, FragmentStudentProfile.class);
    ...
    private void showDialog(String msg, final boolean isBack) {
        final Dialog
                dialog = new Dialog(ChatActivityStudent.this);
    ...
    private void showHideNameConfirmation(final int type) {
        ...
        new AlertDialog.Builder(ChatActivityStudent.this)
                .setTitle(title)
                .setMessage(msg)
    ...
    private void addOnChatHistory() {
        if (!isAddedOnChatHistory) {
            ...
            if (user != null) {
                ...
                ChatFragment.chatUserList.add(chatUser);
            }
        }
    }
    ...
    private ChatUser findObjByIdChat(String id) {
        ChatUser obj = null;
        for (ChatUser chatUser : ChatFragment.chatUserList) {
