...
public class VerifyOtp extends AppCompatActivity implements OnResponseListener {
   ...
   /*
        no1.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    //check if the right key was pressed
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
                        Toast.makeText(getApplicationContext(), "Manoj", Toast.LENGTH_SHORT).show();
                        return true;
                    }
                }
                return false;
        ...
        no2.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    //check if the right key was pressed
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
        ...
        no3.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    //check if the right key was pressed
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
        ...
        no4.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    //check if the right key was pressed
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
        ...
        no2.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (count > 0) {
                    ...
                    no1.requestFocus();
                    no1.setPressed(true);
                } else if (no2.getText().toString().equalsIgnoreCase("")) {
                    no1.requestFocus();
                    no1.setPressed(true);
                }
            }
        ...
        no3.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (count > 0) {
                    ...
                    no2.requestFocus();
                    no2.setPressed(true);
                } else if (no3.getText().toString().equalsIgnoreCase("")) {
                    no2.requestFocus();
                    no2.setPressed(true);
                }
            }
